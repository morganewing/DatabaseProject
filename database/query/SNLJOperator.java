...
public class SNLJOperator extends JoinOperator {
  ...
  public int estimateIOCost() throws QueryPlanException {
    ...
    if (left.getNumPages() != 0) {
      recsPerPage = left.getNumRecords() / left.getNumPages();
    } else {
      recsPerPage = left.getNumRecords();
    }
    return (recsPerPage * left.getNumPages()) * right.getNumPages() + left.getNumPages();
  }
